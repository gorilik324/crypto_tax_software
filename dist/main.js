...
const loadTrades_1 = require("./loadTrades");
const TaxCalcEngine_1 = require("./TaxCalcEngine");
...
function main2() {
    ...
    //loadDataFromGemini();
    //writeDataPoloniex()
    const loadFunctions = [loadTrades_1.loadFromBitstamp, loadTrades_1.loadDataFromGemini, loadTrades_1.loadDataFromBinance, loadTrades_1.loadDataFromBitmex, loadTrades_1.loadDataPoloniex, loadTrades_1.loadAllBitfinexTrades, loadTrades_1.loadDataFromCoinbaseAll];
    ...
    const poloData = (0, loadTrades_1.loadDataPoloniex)();
    ...
    let mktPrcs = (0, mktDataInput_1.loadMktData)(['BTC', 'ETH', 'USDT', 'LTC', 'ZEC', 'BNB', 'EUR', 'BCH', 'XRP', 'BSV', 'XMR', 'ETC']);
    ...
    const USD_FIFO = true;
    const taxCalculator = new TaxCalcEngine_1.TaxCalculator(USD_FIFO, mktPrcs);
...
function runCompare() {
    ...
    const poloData = (0, loadTrades_1.loadDataPoloniex)();
    let last = 0;
    const cointrackingData = (0, loadTrades_1.loadDataFromCoinTracking)("Poloniex");
    ...
    const coinTrackingSales = (0, loadTrades_1.loadCointrackingSales)('data/cointracking_capital_gains_polo_only_2018.csv');
